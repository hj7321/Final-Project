      ...
      <div className="flex flex-1">
        <aside className="w-64  p-4">
          <div className="flex flex-col items-center mb-6   p-4 rounded">
            ...
            <button className="mb-2 px-4  w-[244px] h-[36px] text-white   rounded-s  bg-black ">프로필 수정하기</button>
            <button className="mb-2 px-4  w-[244px] h-[36px] text-white rounded  bg-black">전문가로 전환</button>
          </div>
