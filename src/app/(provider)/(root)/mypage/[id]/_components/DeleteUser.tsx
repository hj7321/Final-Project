...
export default function DeleteUser() {
  ...
  const handleUserDelete = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    const userDeleteData = await fetch('/api/withdrawal', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
    ...
    alert('회원 탈퇴 신청 완료 -> 나중에 모달로 바꿔야 함');
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>• &nbsp;탈퇴 후 회원님의 정보는 전자상거래 소비자보호법에 의거한 코듀 개인정보처리방침에 따라 관리됩니다.</p>
        <p>
