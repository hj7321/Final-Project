        ...
        <div className="md:mt-[40px] mx-auto p-4 flex md:flex-row flex-col justify-between w-full ">
          <div>
            <div className="flex flex-row items-center order-1">
              <Image
                ...
                alt="프로필이미지"
                className="w-[64px] h-[64px] bg-grey-700 rounded-full mr-4"
                width={64}
                height={64}
              />
            ...
            <div className="mt-[30px] order-5" data-color-mode="light">
              ...
              <MDEditor.Markdown
                ...
                line-clamp-4
                className="mt-[20px] px-2 w-full font-thin md:w-400px line-clamp-6"
              />
            </div>
            <div className="mt-[30px] order-6">
              <h2 className="md:text-xl text-lg">참여 기간</h2>
              <p className="mt-[20px] px-2 md:text-base text-sm">
          ...
          <div className="hidden md:block">
            <Image
              ...
              height={300}
              alt="포스트이미지"
              className="md:w-[630px] w-[330px] h-[630px] rounded-xl"
            />
          </div>
        </div>
      </div>
