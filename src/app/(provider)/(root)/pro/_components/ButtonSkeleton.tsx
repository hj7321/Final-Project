export default function ButtonSkeleton() {
  return (
    <button className="md:ml-[85%] w-[124px] h-[48px] bg-grey-50 md:px-5 md:py-3 md:mt-3 md:mr-[0px] px-3 py-2 mt-1 mr-4 flex flex-row justify-center items-center rounded-full"></button>
    // <button
